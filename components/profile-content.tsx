...
// // import { Edit, Plus, User, Settings, X } from 'lucide-react';
// // import { 
// //   Tabs, 
// //   TabsList, 
// //   TabsTrigger,
...
// // import { checkAuth } from '@/app/actions/auth'; // Import checkAuth to refresh user data
...
// //   const { user, loading, signOut, refreshUser } = useAuth(); // Add refreshUser if available
...
// //         // If refreshUser method exists in your auth context, use it
// //         if (refreshUser) {
// //           await refreshUser();
// //         }
// //         // Otherwise, you might need to update the user in the context manually
...
// //     // Map preferences to the required format
// //     const formattedPreferences = preferences.map(pref => ({
// //       preference_type: getPreferenceType(pref), // Helper function to determine type
...
// //       // Refresh user data to get the latest preferences from the database
// //       await refreshUserData();
// //     } else {
// //       toast({
// //         title: "Error",
...
// //   // Helper function to determine preference type
...
// //     return 'other'; // Default type for custom preferences
// //   };
